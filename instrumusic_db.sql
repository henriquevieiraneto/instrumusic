...
CREATE DATABASE IF NOT EXISTS instrumusic_db
...
-- 3. Cria a Tabela de Usuários (users)
-- Esta tabela armazenará as informações de login e cadastro.
...
-- 4. Cria a Tabela de Instrumentos (instruments)
...
-- 5. Popula a Tabela de Instrumentos com dados iniciais
...
-- 6. Cria a Tabela de Cursos (courses)
...
-- 7. Cria Tabela de Matrículas (enrollments)
